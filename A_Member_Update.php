...
<form method="POST" action="A_Member_Edit.php">
...
<input type="text" name="member_name" value="<?php echo $member_name; ?>" required>
</div>
...
<label>
<input type="radio" name="status" value="deactive" <?php echo($status=='deactive')?'checked':'';?>>
 Deactive
</label>
</div>
...
<a href="A_Member_Change_Password.php?id=<?php echo $id; ?>" class="change-btn">
Change Password
</a>

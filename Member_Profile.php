...
<input type="text" value="<?php echo $member_id; ?>" readonly>
</div>

<div class="input-group">
<i class="fa fa-user"></i>
<input type="text" value="<?php echo $member_name; ?>" readonly>
</div>
...
<a href="Member_Update.php?id=<?php echo $id; ?>" class="btn">
<i class="fa fa-pen"></i> Edit Profile
</a>

<a href="Member_Change_Password.php?id=<?php echo $id; ?>" class="btn">

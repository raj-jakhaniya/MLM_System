...
<a href="Buy_Product.php"><i class="fa fa-box"></i>Buy Product</a>
...
<a href="Member_Kyc_View.php" class="active"><i class="fa fa-id-card"></i>E-KYC</a>
...
<form method="POST" action="Member_Kyc_Insert.php" enctype="multipart/form-data">

<div class="input-group">
<i class="fa fa-id-badge"></i>
<input type="text" name="member_id" value="<?php echo $_SESSION['user_id'];?>" readonly>
</div>
...
<i class="fa fa-upload"></i> Submit KYC
</button>

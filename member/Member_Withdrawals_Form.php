...
<h2>Point Withdrawal</h2>

<form method="POST" action="Member_Withdrawals_Insert.php">
...
placeholder="Enter Points" oninput="copyValue()" required>
</div>

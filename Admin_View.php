...
<td>
<a class="btn edit" href="Admin_Update.php?id=<?php echo $id; ?>">Edit</a>
</td>

<td>
<?php
if($admin_id=="{$_SESSION['user_id']}"){
echo "<span class='btn disabled'>Delete</span>";
}else{
echo "<a class='btn delete' href='Admin_Delete.php?id=$id'>Delete</a>";
}
?>
</td>

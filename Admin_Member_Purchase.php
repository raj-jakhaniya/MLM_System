...
<title>Package Purchase History</title>
...
<h2 class="page-title">Package Purchase History</h2>
...
<td>
<a class="btn approve" href="Admin_Member_Purchase_Approve.php?id=<?php echo $id; ?>&member_id=<?php echo $member_id; ?>&package_id=<?php echo $package_id; ?>">Approve</a>
</td>

<td>
<a class="btn reject" href="Admin_Member_Purchase_Reject.php?id=<?php echo $id; ?>">Reject</a>
</td>
...
<td>
<a class="btn delete" href="Admin_Member_Purchase_Delete.php?id=<?php echo $id; ?>">Delete</a>
</td>
